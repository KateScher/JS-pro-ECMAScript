...
функцию-конструктор. Попробуем создать свою версию оператора new в виде
функции: */
...
function createObject(constructor) {
  ...
  // Вызовем функцию-конструктор, передав ей как this созданный
  // на шаге 1 объект, и передадим остальные аргументы, если они были
  // переданы в createObject
